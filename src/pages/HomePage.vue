      ...
      <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                ...
                <div class="box p-5">
                  <div class="flex">
                    <svg
                      ...
                      class="feather feather-credit-card report-box__icon text-theme-11 report-box__icon text-theme-11"
                    >
                      <rect
                        x="1"
                        y="4"
                  ...
                  <div class="text-base text-gray-600 mt-1">Груз</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                ...
                <div class="box p-5">
                  <div class="flex">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="feather feather-shopping-cart report-box__icon text-theme-10 report-box__icon text-theme-10"
                    >
                  ...
                  <div class="text-3xl font-bold leading-8 mt-6">0</div>
                  <div class="text-base text-gray-600 mt-1">Билеты</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                ...
                <div class="box p-5">
                  <div class="flex">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="feather feather-monitor report-box__icon text-theme-12 report-box__icon text-theme-12"
                    >
                      <rect
                        x="2"
                        y="3"
                  ...
                  <div class="text-3xl font-bold leading-8 mt-6">0</div>
                  <div class="text-base text-gray-600 mt-1">Тур пакет</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                ...
                <div class="box p-5">
                  <div class="flex">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="feather feather-user report-box__icon text-theme-9 report-box__icon text-theme-9"
                    >
                      <path
                  ...
                  <div class="text-3xl font-bold leading-8 mt-6">0</div>
                  <div class="text-base text-gray-600 mt-1">Виза</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-span-12 xl:col-span-8 mt-6">
          ...
          <div class="intro-y box p-5 mt-12 sm:mt-5">
            ...
            <div
              class="report-maps mt-5 bg-gray-200 rounded-md"
          ...
          <div class="mt-5">
            <div class="intro-y">
              <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                ...
                <div class="ml-4 mr-auto">
                  ...
                  <div class="text-gray-600 text-xs mt-0.5">18 June 2021</div>
                </div>
                <div
            ...
            <div class="intro-y">
              <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                ...
                <div class="ml-4 mr-auto">
                  ...
                  <div class="text-gray-600 text-xs mt-0.5">17 April 2021</div>
                </div>
                <div
                  class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium"
                >
            ...
            <div class="intro-y">
              <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                ...
                <div class="ml-4 mr-auto">
                  ...
                  <div class="text-gray-600 text-xs mt-0.5">17 July 2021</div>
                </div>
                <div
                  class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium"
                >
            ...
            <div class="intro-y">
              <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                ...
                <div class="ml-4 mr-auto">
                  <div class="font-medium">Johnny Depp</div>
                  <div class="text-gray-600 text-xs mt-0.5">30 March 2022</div>
                </div>
                <div
                  class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium"
                >
        ...
        <div class="xxl:pl-6 grid grid-cols-12 gap-6">
            ...
            <div class="mt-5">
              ...
              <div class="intro-x">
                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                  ...
                  <div class="text-theme-9">+$111</div>
                </div>
              </div>
              <div class="intro-x">
                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
              ...
              <div class="intro-x">
                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                  ...
                  <div class="text-theme-9">+$107</div>
                </div>
              </div>
              <div class="intro-x">
                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                  ...
                  <div class="text-theme-6">-$201</div>
                </div>
              </div>
              <a
                href=""
                    ...
                    <div class="flex mt-2">
                      ...
                      >
                        <img
                          ...
                          src="../assets/images/preview-10.jpg"
                        />
                      </div>
                      <div
                        class="tooltip w-8 h-8 image-fit mr-1 zoom-in"
          ...
          >
            <div class="intro-x flex items-center h-10">
              ...
              >
                <i data-feather="plus" class="w-4 h-4 mr-1"></i> Add New
                Schedules
              </a>
            </div>
            <div class="mt-5">
