  ...
  <div id="app">
              ...
              <a href="" class="flex items-center mt-2">
                <div class="w-8 h-8 image-fit">
                  <img
                    alt="Midone Tailwind HTML Admin Template"
                    class="rounded-full"
                    src="./assets/images/preview-4.jpg"
                  />
                </div>
              ...
              <a href="" class="flex items-center mt-2">
                <div class="w-8 h-8 image-fit">
                  <img
                    alt="Midone Tailwind HTML Admin Template"
                    class="rounded-full"
                    src="./assets/images/preview-7.jpg"
                  />
                </div>
    ...
    <nav class="top-nav">
      <ul>
        <li>
          <a
            href="top-menu-light-dashboard.html"
            class="top-menu top-menu--active"
          >
            <div class="top-menu__icon"><i data-feather="home"></i></div>
            <div class="top-menu__title">Главная страница</div>
          </a>
        </li>
        <li>
          <a href="/about" class="top-menu top-menu--active">
          ...
          <ul class="">
            ...
            <li>
              ...
              <ul class="">
                <li>
                  <a
                    href="top-menu-light-profile-overview-1.html"
                    class="top-menu"
                  >
                    <div class="top-menu__icon"><i data-feather="zap"></i></div>
                ...
                <li>
                  <a
                    href="top-menu-light-profile-overview-2.html"
                    class="top-menu"
                  >
                    <div class="top-menu__icon"><i data-feather="zap"></i></div>
                ...
                <li>
                  <a
                    href="top-menu-light-profile-overview-3.html"
                    class="top-menu"
                  >
                    <div class="top-menu__icon"><i data-feather="zap"></i></div>
    ...
    <router-view />
    <div
      data-url="top-menu-dark-dashboard.html"
